...
public final class Costant {
	...
	final public static float EPSION_MIN=0.2f;
	final public static float DISCOUNT_FACTOR=0.99f;  
	//final public static float DELTA=0.03f;  
	final public static int MAXREP=50000;
	...
	final public static float EXPONENTIAL_DECAY=0.000009f;  //costante di decadimento esponenziale lambda-> formula e^(-t/lambda)
