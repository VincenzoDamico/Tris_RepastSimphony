...
public class TrisBuilder  implements ContextBuilder<Object> {
	...
	public Context build(Context<Object> context) {
		...
		Player1 p1=new Player1 (grid,possibleAction,new AgentX<String>(1,Costant.MARKPL1),dashBoard);
		Player2 p2=new Player2 (grid,possibleAction,new Agent0<String>(2,Costant.MARKPL2),dashBoard);
