...
public abstract class PlayerAbstract extends QlearnigTemplate	{
	...
	public PlayerAbstract (  GridPlayGround grid, int gridDimX, int gridDimY, int winCount, float alpha, float discount_factor, float epsilon, List<Pair<Integer,Integer>>possibleAction, String mark) {
		this.grid = grid ;
