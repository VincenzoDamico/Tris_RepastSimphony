...
public class Player1 extends QlearnigTemplate	{
	...
	public Player1 (  Grid < Object > grid, int gridDimX, int gridDimY, int winCount, int alpha, int discount_factor, int epsilon, List<Pair<Integer,Integer>>possibleAction, String mark) {
		this.grid = grid ;
